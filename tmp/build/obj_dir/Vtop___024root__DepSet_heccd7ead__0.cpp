...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    VL_WRITEF("[%b]: %b\n",4,vlSelf->top__DOT__i,1,
              (IData)(vlSelf->ps2_data));
    vlSelf->top__DOT__i = ((0xaU > (IData)(vlSelf->top__DOT__i))
                            ? (0xfU & ((IData)(1U) 
        ...
        if (vlSelf->ready) {
            if ((1U & (~ (IData)(vlSelf->nextdata_n)))) {
                ...
                if (((IData)(vlSelf->top__DOT__w_ptr) 
                     == (7U & ((IData)(1U) + (IData)(vlSelf->top__DOT__r_ptr))))) {
                    vlSelf->ready = 0U;
                }
            }
        }
...
#endif
                    VL_FATAL_MT("/home/ghhu/Desktop/study/DLCO/tmp/vsrc/top.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/ghhu/Desktop/study/DLCO/tmp/vsrc/top.v", 1, "", "NBA region did not converge.");
            }
