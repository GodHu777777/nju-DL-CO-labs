...
#endif
                VL_FATAL_MT("/home/ghhu/Desktop/study/DLCO/lab7_keyboard/vsrc/top.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([changed] ascii)\n");
    }
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge top.ready)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([changed] ascii)\n");
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge top.ready)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->top__DOT____Vcellout__inst__fifo[__Vi0] = 0;
    }
    ...
    vlSelf->__Vdly__top__DOT__cnt = 0;
    ...
    vlSelf->__Vdly__top__DOT__w_ptr = 0;
    vlSelf->__Vtrigrprev__TOP__ascii = 0;
